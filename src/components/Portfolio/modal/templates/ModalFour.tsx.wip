...
import { PortfolioData } from "@/src/strings";
import Image from "next/image";

export const ModalFour = ({ modalId, setGetModal }) => {
    return (
                    ...
                    return (
                        <div key={item.id} data-aos="fade">
                                    ...
                                    return (
                                        <div key={i} className="row open-sans-font">
                                            ...
                                            <div className="col-12 col-sm-6 mb-2">
                                                ...
                                                Language :{" "}
                                                <span className="ft-wt-600 uppercase">{details.language}</span>
                                            </div>
                                            <div className="col-12 col-sm-6 mb-2">
                            ...
                            <figure className="modal__img">
                                ...
                                <video id="video" className="responsive-video" controls poster={item.image as any}>
